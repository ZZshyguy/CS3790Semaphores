/*
 Java Semaphores
 Zachary Lapointe (plus some of Franco C's code
*/
...
class Semaphore {
	...
	public synchronized void semWait() {//P
		while ( value <= 0) {
			try {
				wait();
	...
	public synchronized void semwait(long delay) throws FailedToPException {//P
